...
# import language_tool_python
# from textstat import flesch_reading_ease, text_standard, sentence_count
# import numpy as np
...
#     num_errors = len(matches)
#     num_sentences = max(sentence_count(text), 1)
#     return max(0, 100 - (num_errors / num_sentences) * 10)  # scale: 0–100
...
#     # Weighted average
#     total = (0.4 * g_score) + (0.4 * r_score) + (0.2 * i_score)
#     return round(min(total, 100), 2)  # Clamp to 100 max